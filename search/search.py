    ...
    while True:
        ...
        if node[0] not in closedSet:
            ...
            for child in problem.getSuccessors(node[0]):
                temp = node[1][:]
                temp.append(child[1])
                cumulativeCost = child[2] + node [2]
                fringe.push((child[0],temp,cumulativeCost),cumulativeCost)
    ...
    while True:
        ...
        if node[0] not in closedSet:
            ...
            for child in problem.getSuccessors(node[0]):
                ...
                temp.append(child[1])
                cumulativeCost = child[2] + node [2]
                priority = cumulativeCost + heuristic(child[0],problem)
                fringe.push((child[0],temp,cumulativeCost),priority)
